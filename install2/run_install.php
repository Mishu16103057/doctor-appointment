...
if (!isset($_POST['web_name']) || $_POST['web_name'] == ""){
  echo "Please Enter Website Name";
    ...
    // Name of the file
    $filename = 'database/prodoctor.sql';
    // MySQL host
    ...
    $chkData = file_get_contents(constant("GENIUSOCEAN").'purchase11221122.php?code='.$purchase_code.'&domain='.$my_domain.'&script='.$my_script);
