...
--
-- Host: localhost:3306
-- Generation Time: Oct 16, 2018 at 12:26 PM
...
CREATE TABLE `admins` (
  ...
  `pareas` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `appointments` (
  ...
  `patient_visit` text COLLATE utf8_unicode_ci,
...
INSERT INTO `appointments` (`id`, `doctorid`, `patient_id`, `patient_name`, `patient_last_name`, `patient_email`, `patient_phone`, `patient_visit`, `patient_insurance`, `insurance_plan`, `visit_for`, `comments`, `appointment_date`, `appointment_time`, `created_at`, `updated_at`, `status`) VALUES
(4, 1, NULL, 'ShaOn1', 'Zaman', 'shaoneel@gmail.com', '4312525243', 'Yes', 'Health Insurance', 'Insurance2', 'Self', 'Test', '2018-09-16', '04:05', '2018-09-12 15:15:28', '2018-09-12 15:15:28', 1),
(5, 1, NULL, 'ShaOn3', 'Zaman', 'shaoneel@gmail.com', '4312525243', 'Yes', 'Health Insurance', 'Insurance2', 'Self', 'Test', '2018-09-12', '04:05', '2018-09-12 15:15:28', '2018-09-12 20:44:49', 2),
(6, 1, 1, 'Test Name', 'Zaman', 'user@gmail.com', '00000000', 'Yes', 'Particular', 'Select Your Health Plan', 'Self', 'Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of \"de Finibus Bonorum et Malorum\" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum, \"Lorem ipsum dolor sit amet..\", comes from a line in section 1.10.32.\r\n\r\nThe standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from \"de Finibus Bonorum et Malorum\" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.', '2018-10-15', '03:30', '2018-10-13 16:42:37', '2018-10-13 16:42:37', 1);
...
(3, 'browser', 'Windows 10', 760, 0, NULL),
...
INSERT INTO `languages` (`id`, `home`, `home1`, `fht`, `home2`, `vt`, `gt`, `vdn`, `about`, `blog`, `faq`, `contact`, `con`, `cop`, `coe`, `cor`, `signin`, `sie`, `spe`, `signup`, `suf`, `suph`, `sue`, `sup`, `sucp`, `dashboard`, `edit`, `reset`, `logout`, `cp`, `np`, `rnp`, `chnp`, `bgs`, `rds`, `hcs`, `lns`, `lm`, `vd`, `ston`, `s`, `fl`, `sm`, `fpw`, `fpt`, `fpe`, `fpb`, `cn`, `al`, `bg`, `dni`, `search`, `ec`, `sbg`, `ss`, `bs`, `dopd`, `doo`, `dol`, `doa`, `doe`, `dor`, `dopr`, `doc`, `doci`, `dosp`, `don`, `doem`, `dom`, `fname`, `cup`, `pp`, `app`, `size`, `md`, `amf`, `doct`, `doad`, `doph`, `dofx`, `dofpl`, `dotpl`, `dogpl`, `dolpl`, `doeml`, `doupl`, `supl`, `success`, `dttl`, `ddesc`, `ppr`, `fpr`, `age`, `appointment`, `p_appointments`, `h_appointments`, `no_appointments`, `my_info`, `select_datetime`, `continue_btn`, `h_format`, `available_times`, `chose_datetime`, `confirmation`, `confirmed`, `successfull`, `reservation`, `you_will`, `please_fillup`, `consultation_for`, `first_visit`, `yes`, `no`, `select_plan`, `withorwithout`, `for_me`, `for_another`, `patient_name`, `patient_lastname`, `patient_email`, `patient_phone`, `purpose_of_visit`) VALUES
(1, 'HOME', 'DOCTOR PROFILE', 'IMAGE GALLERY', 'MY SERVICES', 'BLOGS', 'BLOG DETAILS', 'FREQUENTLY ASKED QUESTION', 'ABOUT ME', 'BLOG', 'FAQ', 'CONTACT ME', 'Your Name', 'Your Phone', 'Your Email', 'Write a Replay', 'SIGN IN', 'Email', 'Password', 'SIGN UP', 'Full Name', 'Phone Number', 'Email', 'Password', 'Confirm Password', 'DASHBOARD', 'Edit Profile', 'RESET PASSWORD', 'LOG OUT', 'Current Password', 'New Password', 'Re-Type New Password', 'Change Password', 'All Available Sectors', 'Featured Handymen', 'HAPPY CUSTOMERS', 'LATEST BLOGS', 'View More', 'View Details', 'SUBSCRIBE TO OUR NEWSLETTER', 'SUBSCRIBE', 'FOOTER LINKS', 'Send Message', 'FORGOT PASSWORD?', 'FORGOT PASSWORD', 'Enter Email', 'SUBMIT', 'Practice Areas', 'My Resume', 'Category:', 'HandyMen Found in :', 'Search', 'Enter City', 'Select Category', 'Recent Posts', 'Source', 'Profile Description', 'Others', 'Language', 'Gender', 'Education', 'Residency', 'Profession', 'Contact', 'Contact Info', 'Share Profile', 'Name:', 'Email:', 'Message:', 'Full Name', 'Current Photo', 'Profile Photo', 'Add Profile Photo', 'Preferred Size: (600x600) or Square Sized Image', 'More Details', 'Add More Field', 'City', 'Address', 'Phone', 'Fax', 'Facebook Profile Link', 'Twitter Profile Link', 'Google+ Profile Link', 'Linkedin Profile Link', 'Website', 'Update Profile', 'Enter Your Email', 'Successfully updated your profile', 'Enter Title', 'Enter Text/Details', 'Publish My Profile', 'Feature My Profile', 'Age', 'Appointment', 'Pending Appointments', 'Appointment History', 'No Appointments', 'My Health Information', 'Please Select a Date & Time!', 'CONTINUE', 'Time slots are in 24hrs format.', 'Available Times For Date', 'Choose Appointment Date & Time Slot', 'Confirmation of Reservation', 'Appointment Confirmed !', 'Your appointment confirmed successfully', 'Reservation of Consultation', 'You will make an appointment for', 'Please fill up following informations', 'Who is the consultation for?', 'Is this your first visit?', 'Yes', 'No', 'Select Your Health Plan', 'With or Without Insurance?', 'For Me', 'For Another Person', 'Patient Name', 'Patient Last name', 'Patient Email', 'Patient Phone', 'Purpose of visit/Comments');
...
CREATE TABLE `schedules` (
  ...
  `sunday_times` text COLLATE utf8_unicode_ci,
  `monday_times` text COLLATE utf8_unicode_ci,
  `tuesday_times` text COLLATE utf8_unicode_ci,
  `wednesday_times` text COLLATE utf8_unicode_ci,
  `thursday_times` text COLLATE utf8_unicode_ci,
  `friday_times` text COLLATE utf8_unicode_ci,
  `saturday_times` text COLLATE utf8_unicode_ci,
  `accepted_insurance` text COLLATE utf8_unicode_ci,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `status` int(11) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 1, '01:30', '03:20', '04:30', '07:30', '17:30', '15:00', '01:05', '05:30', '06:20', '09:30', '12:30', '20:30', '20:00', '11:05', '01:05,02:05,04:05,05:05,06:05,07:05,09:05,10:05', '01:30,03:30,04:30', '03:20,04:20,05:20', '04:30,05:30,06:30,08:30', '07:30,08:30,10:30,11:30', '17:30,18:30,19:30', '15:00,16:00,17:00,18:00,19:00', 'Insurance1,Insurance2,Insurance3', '2018-03-19 17:11:56', '2018-05-03 11:31:39', 1);
...
INSERT INTO `services` (`id`, `title`, `description`, `photo`) VALUES
(1, 'Design', '<span style=\"color: rgb(0, 0, 0); font-family: Roboto, sans-serif;\">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur iure eum to accusamus repellendus at quasi sequi</span><br>', '1524544238First-Aid-Kit-02-128.png'),
(2, 'Design', '<span style=\"color: rgb(0, 0, 0); font-family: Roboto, sans-serif;\">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur iure eum to accusamus repellendus at quasi sequi</span><br>', '1524544271Heart-ECG-128.png'),
(3, 'Design', '<span style=\"color: rgb(0, 0, 0); font-family: Roboto, sans-serif;\">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur iure eum to accusamus repellendus at quasi sequi</span><br>', '1524544361Ambulance-128.png'),
(4, 'Design', '<span style=\"color: rgb(0, 0, 0); font-family: Roboto, sans-serif;\">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur iure eum to accusamus repellendus at quasi sequi</span><br>', '1524544425Doctor-128.png'),
(5, 'Design', '<span style=\"color: rgb(0, 0, 0); font-family: Roboto, sans-serif;\">orem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur iure eum to accusamus repellendus at quasi sequi</span><br>', '1524544447Blood-128.png'),
(6, 'Design', '<span style=\"color: rgb(0, 0, 0); font-family: Roboto, sans-serif;\">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur iure eum to accusamus repellendus at quasi sequi</span><br>', '1524544510Caduceus-128.png');
...
INSERT INTO `specialists` (`id`, `title`, `description`, `photo`) VALUES
(1, 'Hearing Tests & Aids', '<span style=\"font-family: Roboto, sans-serif;\">Unlike traditio method you can see in real time what is or is not working for your business online.</span><br>', '1524506306Stethoscope-01-128.png'),
(2, 'Hearing Tests & Aids', '<span style=\"font-family: Roboto, sans-serif;\">Unlike traditio method you can see in real time what is or is not working for your business online.</span><br>', '1524506353Hospital-Lab-128.png'),
(3, 'Hearing Tests & Aids', '<span style=\"font-family: Roboto, sans-serif;\">Unlike traditio method you can see in real time what is or is not working for your business online.</span><br>', '1524506378Eye-Hospital-128.png');
...
CREATE TABLE `user_profiles` (
  ...
  `my_info` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
...
INSERT INTO `user_profiles` (`id`, `name`, `gender`, `age`, `phone`, `fax`, `profile_photo`, `email`, `password`, `country`, `address`, `city`, `zip`, `my_info`, `created_at`, `updated_at`, `remember_token`, `status`) VALUES
(1, 'Test Name', 'Male', 27, '00000000', '2345235', '1539431121GO-logo.jpg', 'user@gmail.com', '$2y$10$BzurrvL/G7J.L1d5SM8M7ukvmgGLB.s4gl5gulgqVN9PC.0SbcuXS', NULL, '19/7 Kelliwood, Texas', NULL, NULL, 'This Is my Health Bio', '2018-10-11 21:14:16', '2018-10-13 19:37:29', NULL, 1);
