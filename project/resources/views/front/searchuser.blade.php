...
<div class="hero-area overlay" style="background-image: url({{asset('assets/images/'.$gs->bgimg)}});">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="donors-header text-center">{{count($users)}} {{$lang->dni}} {{$catt->cat_name}}</h1>
                        <div class="hero-form">
                                  ...
                                  {{csrf_field()}}
                                    <div class="row">
                                        <div class="col-md-5">
                                         ...
                                         <input list="cities" type="search" name="search" id="country" class="form-control" placeholder="Enter City" value="{{$search}}">
