                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="add-product-box">
                                        ...
                                        <form class="form-horizontal" action="{{ route('doctor-schedule-update')}}" method="POST">
                                          {{csrf_field()}}
...
@section('scripts')
    <script>
        ...
        function tpMinMaxSetMinTime( hour, minute, day ) {
            generateTimes(day);
            $('#'+day+'_end').timepicker('option', { minTime: { hour: 0, minute: 0+20} });
        }
        ...
        function generateTimes(day) {
            ...
            if(start != "" && end != ""){
                $.get("{{url('doctor/check/times/schedule?start=')}}"+start+"&end="+end+"&day="+day, function(data, status){
                    //alert("Data: " + data + "\nStatus: " + status);
