    ...
    <table id="example" class="table table-striped table-hover">
                                              ...
                                              <tr role="row" class="odd">
                                                  ...
                                                  <td>
                                                      ...
                                                      <a href="{{route('doctor-user-appointments',$user->id)}}" class="btn btn-success product-btn"><i class="fa fa-list"></i> Appointments</a>
                                                      <a href="{{route('doctor-user-edit',$user->id)}}" class="btn btn-warning product-btn"><i class="fa fa-edit"></i> Edit</a>
                                                      <a href="{{route('doctor-user-delete',$user->id)}}" class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Remove</a>
                                                  </td>
                                              </tr>
                                                  @endforeach
                                                  </tbody>
...
<script type="text/javascript">
  $('#example').DataTable();
  function GetData(id){
      $('#AppData').load('{{url('doctor/patient/details')}}/'+id);
  }
</script>
