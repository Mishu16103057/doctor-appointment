                                    ...
                                    <div class="add-product-box">
                                        ...
                                        @include('includes.form-success')
                                          ...
                                          <div class="form-group">
                                            ...
                                            <img src="{{ $admin->pimg ? asset('assets/images/'.$admin->pimg):'http://fulldubai.com/SiteImages/noimage.png'}}" alt="No Photo" style="height: 350px; width: 280px" id="adminimg">
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="edit_profile_photo">Choose Image</label>
                                            <div class="col-sm-6">
                                    <input type="file" id="uploadFile" class="hidden" name="pimg" value="">
