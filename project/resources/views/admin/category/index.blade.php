                                      ...
                                      <div class="row">
                                        ...
                                        <table id="example" class="table table-striped table-hover products dt-responsive dataTable no-footer dtr-inline" role="grid" aria-describedby="product-table_wrapper_info" style="width: 100%;" width="100%" cellspacing="0">
                                              ...
                                              <tr role="row" class="odd">
                                                      <td tabindex="0" class="sorting_1"><img src="{{ $cat->photo ? asset('assets/images/'.$cat->photo):'http://fulldubai.com/SiteImages/noimage.png'}}" alt="Category's Photo" style="height: 180px; width: 200px;"></td>
                                                      <td>{{$cat->cat_name}}</td>
                                                      <td>{{$cat->cat_slug}}</td>
                                                      <td>
