                                    ...
                                    <div class="add-product-box">
                                        ...
                                        <form class="form-horizontal" action="{{route('admin-rs-create')}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="subtitle" id="edit_language" placeholder="Enter SubTitle" required="" type="text" value="">
                                            </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="duration" id="edit_language" placeholder="Enter DUration" required="" type="text" value="">
                                            </div>
                                          </div>
                                          <div class="form-group">
                                          ...
                                          <hr>
                                            <div class="add-product-footer">
                                                <button name="addProduct_btn" type="submit" class="btn add-product_btn">Create Resume</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
