...
class PortfolioController extends Controller
{
  ...
  public function index()
    ...
    public function update(StoreValidationRequest $request, $id)
    {
        ...
        $ad->update($data);
        return redirect()->route('admin-ad-index')->with('success','Advertisement Updated Successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        if($ad->photo == null){
        $ad->delete();
        return redirect()->route('admin-ad-index')->with('success','Advertisement Deleted Successfully.');
        }
        unlink(public_path().'/assets/images/'.$ad->photo);
        $ad->delete();
        return redirect()->route('admin-ad-index')->with('success','Advertisement Deleted Successfully.');
